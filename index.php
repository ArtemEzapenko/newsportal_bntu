...
<head>
 <link rel="shortcut icon" href="/img/favicon.ico" type="image/x-icon">
	<meta charset="utf-8">
	<title>BNTU News — новостной портал БНТУ</title>
...
<body>
	...
	<header>
		...
		<nav class="menu">
			<ul>
				<?php
				echo "<li class=\"active\"><a href=\"http://news/index.php\">Главная</a></li>
		...
		<div class="all_articles">
			<?php
		 	for ($i = 1; $i<50;$i++){
				...
				$img=Parse($desc,'src="http://','.jpg"').".jpg";
				$category=substr(Parse($link,"-","-news"),1);
		 		if($category=="iifoimo" || $category=="fitr" ||  $category=="sports" ||  $category=="fes" || $category=="psf"){
				 		if ($img!="0.jpg"){
				 			$img=substr($img,5);
